...
- 2026-08-08, only 6 of 26 core prompts have a behavioral eval (`interrogate`, `plan-change`,
  `record-decision`, `write-tests`, `debt-log`, `orient-repo`; see
  ...
  the existing six as a template.
