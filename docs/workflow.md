...
The kit ships <!-- GENERATED:core-count-digits -->24<!-- /GENERATED:core-count-digits --> prompts, grouped by stage.
...
| Scrutiny | `self-refute` `grill` `prove` `panel` `repo-review` | challenge your own fresh output, a design, plan, or diff, or claims that must survive scrutiny; convene expert lenses for a wide decision |
