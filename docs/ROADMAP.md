...
|---|---|---|
| Prompt pack | built | The core pack is <!-- GENERATED:core-count-words -->twenty-seven<!-- /GENERATED:core-count-words --> prompts by stage: <!-- GENERATED:stage-counts -->two start, three plan, five build, six review and ship, one converge, seven scrutiny, two record, and one write<!-- /GENERATED:stage-counts -->, widened by the review suite's `repo-review`, `simplify`, and `triage` (ADR-0011) |
