...
|---|---|---|
| Prompt pack | built | The core pack is <!-- GENERATED:core-count-words -->twenty-five<!-- /GENERATED:core-count-words --> prompts by stage: <!-- GENERATED:stage-counts -->two start, three plan, five build, five review and ship, one converge, six scrutiny, two record, and one write<!-- /GENERATED:stage-counts -->, widened by the review suite's `repo-review`, `simplify`, and `triage` (ADR-0011) |
...
| Checks | built | `python validate.py`: <!-- GENERATED:checks-line -->twenty checks (structure, catalog, prompts, templates, adapters, docs, secrets, voice, banned_sync, template_refs, templates_sync, docs_sync, doc_truth, plugin_sync, plugin_orphans, registries, roadmap, command_lists, traces, label_refs)<!-- /GENERATED:checks-line --> |
